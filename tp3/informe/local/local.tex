...
Se generó una familia de grafos en la que ya sabemos el valor de $\omega_2$ de la solución óptima, para cualquier tamaño de grafo. Nos aseguramos
de que haya una gran cantidad de caminos, como para que el algoritmo deba buscar antes de encontrarlo. Probablemente haya un factor que se
amortice, habiendo escapado de nuestro escrutinio.
