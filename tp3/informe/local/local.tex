...
Se generó una familia de grafos en la que ya sabemos el valor de $\omega_2$ de la solución óptima, para cualquier tamaño de grafo. Experimentamos
con distintas densidades de grafos. Primero con grafos densos, es decir con una cantidad de aristas del orden de $n^2$. Luego con grafos
de densidad media, con una cantidad de aristas del orden de $\sqrt{n}*n$. Finalmente probamos con grafos ralos, con una cantidad de aristas
